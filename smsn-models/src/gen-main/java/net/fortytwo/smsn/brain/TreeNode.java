...
public class TreeNode implements Serializable {
  ...
  public static final hydra.core.Name FIELD_NAME_TEXT = new hydra.core.Name("text");

  public static final hydra.core.Name FIELD_NAME_SHORTCUT = new hydra.core.Name("shortcut");
  ...
  public final hydra.util.Opt<String> text;

  public final hydra.util.Opt<String> shortcut;
  ...
  public TreeNode (net.fortytwo.smsn.brain.AtomId id, net.fortytwo.smsn.brain.Timestamp created, net.fortytwo.smsn.brain.Normed weight, hydra.util.Opt<net.fortytwo.smsn.brain.Normed> priority, net.fortytwo.smsn.brain.SourceName source, String title, hydra.util.Opt<String> alias, hydra.util.Opt<String> text, hydra.util.Opt<String> shortcut, java.util.List<net.fortytwo.smsn.brain.TreeNode> children, Integer numberOfChildren, Integer numberOfParents) {
  ...
  public boolean equals(Object other) {
    ...
    return id.equals(o.id) && created.equals(o.created) && weight.equals(o.weight) && priority.equals(o.priority) && source.equals(o.source) && title.equals(o.title) && alias.equals(o.alias) && text.equals(o.text) && shortcut.equals(o.shortcut) && children.equals(o.children) && numberOfChildren.equals(o.numberOfChildren) && numberOfParents.equals(o.numberOfParents);
  }
  
  @Override
  public int hashCode() {
    return 2 * id.hashCode() + 3 * created.hashCode() + 5 * weight.hashCode() + 7 * priority.hashCode() + 11 * source.hashCode() + 13 * title.hashCode() + 17 * alias.hashCode() + 19 * text.hashCode() + 23 * shortcut.hashCode() + 29 * children.hashCode() + 31 * numberOfChildren.hashCode() + 37 * numberOfParents.hashCode();
  }
  
  public TreeNode withId(net.fortytwo.smsn.brain.AtomId id) {
    java.util.Objects.requireNonNull((id));
    return new TreeNode(id, created, weight, priority, source, title, alias, text, shortcut, children, numberOfChildren, numberOfParents);
  }
  ...
  public TreeNode withText(hydra.util.Opt<String> text) {
    java.util.Objects.requireNonNull((text));
    return new TreeNode(id, created, weight, priority, source, title, alias, text, shortcut, children, numberOfChildren, numberOfParents);
  }

  public TreeNode withShortcut(hydra.util.Opt<String> shortcut) {
    java.util.Objects.requireNonNull((shortcut));
    return new TreeNode(id, created, weight, priority, source, title, alias, text, shortcut, children, numberOfChildren, numberOfParents);
  }
