/* BMP085 Extended Example Code
  by: Jim Lindblom (with modifications by Joshua Shinavier)
...
void BMP085::setup()
{
    ...
    // It appears to be OK to call Wire.begin() more than once
    Wire.begin();
...
short BMP085::getLastTemperature()
{
    return temperature;
}

long BMP085::getLastPressure()
{
    return pressure;
}
