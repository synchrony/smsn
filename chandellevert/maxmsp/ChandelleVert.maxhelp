{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 168.0, 248.0, 581.0, 418.0 ],
		"bglocked" : 0,
		"defrect" : [ 168.0, 248.0, 581.0, 418.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Message",
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 313.0, 150.0, 20.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Select baud",
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 153.0, 150.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 156.0, 67.0, 18.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 2
...
, 			{
				"box" : 				{
					...
					"text" : "Select port",
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 128.0, 150.0, 20.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "port usbserial-A9007VCw",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 130.0, 147.0, 18.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 2
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 309.0, 105.0, 150.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "print",
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 313.0, 34.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 81.5, 174.0, 82.5, 174.0 ]
				}
