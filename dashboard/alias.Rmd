...
`@alias` values are not necessarily HTTP URIs, but many of them are; they are used as bookmarks to link to resources on the Web. Below are the domains of HTTP or HTTPS URI aliases in the current graph, ranked by frequency.
