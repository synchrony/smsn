...
public class MyOtherBrainTest {
    ...
    public void testConfigurationProperties() throws Exception {
        TypedProperties props = ExtendoBrain.getConfiguration();

        assertEquals(new URI("http://myotherbrain.fortytwo.net/"), props.getURI(ExtendoBrain.BASE_URI));
        ...
        assertEquals(new URI("http://example.org/"), props.getURI(ExtendoBrain.BASE_URI));
    ...
    public void testVersionInfo() {
        assertEquals("MyOtherBrain 0.2-SNAPSHOT, revision #-1", ExtendoBrain.getVersionInfo());
    }
}
